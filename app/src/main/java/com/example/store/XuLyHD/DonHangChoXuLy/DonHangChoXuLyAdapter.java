...
public class DonHangChoXuLyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tvMaDH.setText("Mã đơn hàng: " + bill.getId());
        viewHolder.tvTenNguoiDat.setText("Tên người đặt: " + bill.getName());
        ...
        dataBill.child("blacklist").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if (snapshot.getKey().equals(bill.getId_user())) {
                    viewHolder.imgBlacklistIconDHCXL.setImageResource(R.drawable.squid_game_006);
                }
            }
